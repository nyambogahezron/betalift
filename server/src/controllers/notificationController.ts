...
export const getNotifications = asyncHandler(async (req: AuthRequest, res: Response) => {
	...
	const limit = Math.min(parseInt(req.query.limit as string) || ENV.defaultPageSize, ENV.maxPageSize)
...
// @access  Private
export const deleteAllNotifications = asyncHandler(async (req: AuthRequest, res: Response) => {
	if (!req.user) {
		throw new ForbiddenError()
	}
