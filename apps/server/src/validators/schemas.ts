...
export const createProjectSchema = z.object({
	...
	repositoryUrl: z.string().url({ message: 'Invalid repository URL' }).optional(),
...
export const updateProjectSchema = z.object({
	...
	status: z.enum(['planning', 'development', 'testing', 'released', 'archived']).optional(),
})
...
export const createReleaseSchema = z.object({
	...
	releaseType: z.enum(['alpha', 'beta', 'rc', 'stable']).optional().default('beta'),
...
export const createConversationSchema = z.object({
	participantIds: z.array(mongoIdSchema).min(1, 'At least one participant is required'),
