...
export const mockUserEngagements: Record<string, UserEngagement> = {
	demo: {
		...
		interests: ['Mobile Apps', 'AI/ML', 'Developer Tools', 'Productivity', 'Gaming', 'Finance'],
		skills: ['React Native', 'TypeScript', 'Node.js', 'Swift', 'Kotlin', 'Firebase'],
	...
	u5: {
		...
		interests: ['Security Testing', 'Edge Cases', 'Performance', 'Localization'],
		skills: ['Penetration Testing', 'Load Testing', 'API Testing', 'Mobile Testing'],
...
export const mockJoinRequests: JoinRequest[] = [
	{
		...
		user: mockUsers.find((u) => u.id === 'u2')!,
		status: 'pending',
		message: "Hi! I'm a QA engineer with 5 years of experience. I'd love to help test TaskFlow Pro!",
	...
	},
	{
		...
		user: mockUsers.find((u) => u.id === 'u5')!,
		status: 'pending',
		message: 'Professional tester here. I can test on multiple devices and provide detailed bug reports.',
	...
	},
	{
		...
		user: mockUsers.find((u) => u.id === 'u7')!,
		status: 'pending',
		message: 'Love testing productivity apps. I have experience with similar task management apps.',
	...
	},
	{
		...
		user: mockUsers.find((u) => u.id === 'u3')!,
		status: 'pending',
		message: 'UI/UX designer here! Would love to provide design feedback on the fitness app.',
	...
	},
	{
		...
		user: mockUsers.find((u) => u.id === 'u1')!,
		status: 'pending',
		message: 'Finance apps are my specialty. Happy to provide thorough testing.',
...
export const mockConversations: Conversation[] = [
	{
		...
		lastMessage: {
			...
			senderId: 'u1',
			content: "Thanks for the detailed feedback! I'll fix those issues in the next release.",
			type: 'text',
	...
	},
	{
		...
		lastMessage: {
			...
			senderId: 'u3',
			content: "Hey! Would you mind checking out my new app? I think you'd be a great fit for testing it.",
			type: 'text',
	...
	},
	{
		...
		lastMessage: {
			...
			senderId: 'demo',
			content: 'The crash bug is fixed now. Let me know if you find anything else!',
			type: 'text',
	...
	},
	{
		...
		lastMessage: {
			...
			senderId: 'u6',
			content: 'Great feedback on RecipeBox! Working on those improvements now.',
			type: 'text',
...
export const mockMessages: Record<string, Message[]> = {
	conv1: [
		...
		},
		{
			...
			conversationId: 'conv1',
			senderId: 'demo',
			content: "That would be great! What's your experience with React Native apps?",
			type: 'text',
		...
		},
		{
			...
			conversationId: 'conv1',
			senderId: 'demo',
			content: "Perfect! I'll add you to the beta tester list. You should get an invite soon.",
			type: 'text',
		...
		},
		{
			...
			conversationId: 'conv1',
			senderId: 'demo',
			content: 'Thanks for catching that! Can you send me a screenshot or screen recording?',
			type: 'text',
	...
	conv2: [
		{
			...
			conversationId: 'conv2',
			senderId: 'u2',
			content: 'Hi! I noticed you created BudgetBuddy. Would you like some testing help?',
			type: 'text',
...
export const getUserEngagement = (userId: string): UserEngagement | undefined => {
