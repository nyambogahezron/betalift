...
interface SocketContextType {
    socket: Socket | null;
    isConnected: boolean;
    sendMessage: (conversationId: string, content: string, type?: 'text' | 'image' | 'video' | 'file', attachments?: any[]) => void;
...
export const SocketProvider = ({ children }: SocketProviderProps) => {
    ...
    const sendMessage = (conversationId: string, content: string, type: 'text' | 'image' | 'video' | 'file' = 'text', attachments: any[] = []) => {
    ...
    return (
        <SocketContext.Provider value={{ socket, isConnected, sendMessage, joinConversation }}>
            {children}
