...
import type { FeedbackPriority, FeedbackStatus, FeedbackType } from '@/interfaces'
...
export function StatusBadge({ status }: { status: FeedbackStatus }) {
	const config: Record<FeedbackStatus, { label: string; variant: BadgeVariant }> = {
...
export function PriorityBadge({ priority }: { priority: FeedbackPriority }) {
	const config: Record<FeedbackPriority, { label: string; variant: BadgeVariant }> = {
...
export function ProjectStatusBadge({ status }: { status: 'active' | 'beta' | 'closed' | 'paused' }) {
