							...
							style={[
								styles.availabilityDot,
								{
									backgroundColor: getAvailabilityColor(
										engagement.availability.status,
									),
								},
							]}
						/>
					...
					<View style={styles.detailRow}>
						...
						<Text style={styles.detailValue}>
							{engagement.availability.preferredContactMethod === "in-app"
								? "In-App Messaging"
								: engagement.availability.preferredContactMethod ||
									"Not specified"}
						</Text>
					</View>
				</View>
					...
					engagement.projectsViewed.map((view, index) => (
						<Pressable
							...
							style={[
								...
								index < engagement.projectsViewed.length - 1 &&
									styles.viewedProjectBorder,
							]}
							onPress={() => router.push(`/project/${view.projectId}`)}
						>
							<View style={styles.viewedProjectInfo}>
								<Text style={styles.viewedProjectName}>
			...
			<Card style={styles.card}>
				...
				<View style={styles.activityStats}>
					...
					<View style={styles.activityStatItem}>
						<Text style={styles.activityStatValue}>
							{Math.round(
								engagement.projectsViewed.reduce(
