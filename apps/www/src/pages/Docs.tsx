...
const creatorDocs = [
  { title: "Creating Your First Project", href: "/docs/creators/first-project" },
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {quickLinks.map((link, i) => (
              ...
              >
                <div className={`w-12 h-12 rounded-xl ${link.bgColor} flex items-center justify-center mb-4`}>
                  <link.icon className={`w-6 h-6 ${link.color}`} />
                </div>
                <h3 className="font-display font-bold text-lg mb-2">{link.title}</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-display text-2xl font-bold">For Creators</h2>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Integrate Betalift into your existing workflow with our comprehensive REST API. 
