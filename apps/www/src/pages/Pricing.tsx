...
const faqs = [
	...
	},
	{
		...
		answer:
			"We accept all major credit cards, PayPal, and for Enterprise plans, we also support invoicing.",
	},
	{
						...
						{plans.map((plan, i) => (
							...
							>
								...
								<div className="flex items-center gap-3 mb-4">
									<div
										className={`w-12 h-12 rounded-xl ${plan.popular ? "bg-primary/10" : "bg-secondary"} flex items-center justify-center`}
									>
										<plan.icon
											className={`w-6 h-6 ${plan.popular ? "text-primary" : "text-foreground"}`}
										/>
									</div>
				...
				<div className="container mx-auto px-4">
					...
					>
						<p className="text-muted-foreground">
							All plans include SSL encryption, 99.9% uptime SLA, and our core
							platform features. Need something specific?{" "}
				...
				<div className="container mx-auto px-4">
					...
					>
						...
						<p className="text-muted-foreground mb-8">
							Join thousands of creators using Betalift. No credit card
							required.
						</p>
						<a
							href="/download"
