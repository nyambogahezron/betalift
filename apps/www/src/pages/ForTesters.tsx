...
const benefits = [
	{
		...
		title: "Early Access",
		description:
			"Be among the first to try exciting new apps before they're released to the public.",
	},
	{
		icon: Star,
		title: "Build Your Reputation",
		description:
			"Earn badges, build your profile, and become a trusted tester in the community.",
	},
	{
		icon: MessageSquare,
		title: "Direct Impact",
		description:
			"Your feedback shapes the products. Creators actively listen and implement suggestions.",
	},
	{
		icon: Award,
		title: "Recognition",
		description:
			"Get credited for your contributions. Great testers are highlighted and appreciated.",
	},
	{
		icon: Clock,
		title: "Flexible Testing",
		description:
			"Test on your own schedule. There's no pressure—contribute when you have time.",
	},
	{
		icon: Users,
		title: "Community",
		description:
			"Join a community of fellow testers and creators passionate about building great products.",
	},
];
...
const steps = [
	{
		...
		description:
			"Sign up and set up your tester profile. Tell creators about your interests and devices.",
	},
	{
		number: "02",
		title: "Discover Projects",
		description:
			"Browse the discovery feed or search for projects that match your interests.",
	},
	{
		number: "03",
		title: "Join & Test",
		description:
			"Request to join projects and start testing. Download beta apps and explore.",
	},
	{
		number: "04",
		title: "Submit Feedback",
		description:
			"Report bugs, suggest features, or share what you love about the product.",
	},
];
...
const testimonials = [
	{
		quote:
			"I've tested over 50 apps on Betalift. Some of my favorite apps today are ones I tested in beta!",
		author: "Jamie Rodriguez",
		role: "Power Tester, 150+ Projects",
	},
	{
		quote:
			"The creators here actually listen. I suggested a feature last month and it's already in the app.",
		author: "Alex Kim",
				...
				<div className="container relative z-10 mx-auto px-4">
					...
					>
						...
						<h1 className="font-display text-4xl md:text-6xl font-bold text-foreground mb-6">
							Discover <span className="highlight-box">Tomorrow's Apps</span>{" "}
							Today
						</h1>
				...
				<div className="container mx-auto px-4">
					...
					>
						...
						<p className="text-muted-foreground mb-8">
							Join thousands of testers already exploring the future of apps.
