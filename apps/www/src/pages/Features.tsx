...
const creatorFeatures = [
  {
    ...
    description: "Share your beta projects with detailed descriptions, screenshots, and download links (TestFlight, Play Store, etc.).",
  },
  {
    icon: Users,
    title: "Tester Recruitment",
    description: "Attract testers through public listings or manage invite-only access for exclusive testing groups.",
  },
  {
    icon: MessageSquare,
    title: "Structured Feedback",
    description: "Collect organized feedback with categories: bugs, features, improvements, and praise.",
  },
  {
    icon: BarChart3,
    title: "Analytics Dashboard",
    description: "Track tester engagement, feedback trends, and project health with detailed analytics.",
  },
  {
    icon: GitBranch,
    title: "Release Management",
    description: "Manage releases, changelogs, and version history all in one place.",
  },
  {
    icon: Bell,
    title: "Smart Notifications",
    description: "Get notified instantly when new feedback arrives or testers join your project.",
  },
];
...
const testerFeatures = [
  {
    ...
    description: "Browse and join exciting beta projects across categories that match your interests.",
  },
  {
    icon: Star,
    title: "Build Reputation",
    description: "Earn badges and build your reputation as a valuable beta tester in the community.",
  },
  {
    icon: Clock,
    title: "Early Access",
    description: "Get exclusive early access to apps and features before they're released publicly.",
  },
  {
    icon: MessageSquare,
    title: "Direct Communication",
    description: "Chat directly with creators and collaborate on improving their products.",
  },
  {
    icon: Smartphone,
    title: "Cross-Platform",
    description: "Test apps on iOS, Android, and web platforms from a single account.",
  },
  {
    icon: Zap,
    title: "Easy Feedback",
    description: "Submit feedback quickly with our intuitive forms and screenshot tools.",
  },
];
...
const platformFeatures = [
  ...
  },
  {
    icon: Smartphone,
    title: "Native Apps",
    description: "Beautiful native apps for iOS and Android with full feature parity.",
    color: "text-primary",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Get your beta projects in front of real users and gather actionable feedback
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-secondary/30">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Join beta programs, provide valuable feedback, and shape the future of products
            </p>
          </motion.div>
