...
import { Smartphone, Apple, Monitor, QrCode, Download as DownloadIcon, CheckCircle } from "lucide-react";
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-12">
              Get the app on your favorite platform and start discovering truth together.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12">
            ...
            >
              ...
              <h3 className="font-display text-xl font-bold mb-2">Android App</h3>
              <p className="text-muted-foreground text-sm mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Point your phone's camera at the QR code to quickly download the app on your mobile device.
                </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">iPhone, iPad, iPod touch</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">Android 8.0 or later</p>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">Chrome, Firefox, Safari</p>
              <p className="text-sm text-muted-foreground">Edge (latest versions)</p>
            </motion.div>
          </div>
        </div>
      </section>
