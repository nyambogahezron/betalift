...
const featuredPost = {
  ...
  excerpt: "We're excited to announce the biggest update to Betalift yet, featuring a completely redesigned interface, powerful new tools, and enhanced collaboration features.",
...
const posts = [
  {
    ...
    excerpt: "Learn the strategies that top creators use to gather meaningful feedback and build better products.",
  ...
  },
  {
    ...
    excerpt: "A comprehensive guide to becoming a standout beta tester that creators love working with.",
  ...
  },
  {
    ...
    excerpt: "Discover how one startup used Betalift to revolutionize their testing process and ship with confidence.",
  ...
  },
  {
    ...
    excerpt: "Understanding what motivates testers and how to create an environment that encourages quality feedback.",
    category: "Insights",
  ...
  },
  {
    ...
    excerpt: "How to protect your project and testers while maintaining an open and collaborative testing environment.",
    category: "Security",
    date: "January 8, 2026",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt: "Turn your testers into advocates and build a community that supports your product long after launch.",
    category: "Community",
    date: "January 5, 2026",
    readTime: "6 min read",
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground">
              Insights, tips, and stories from the world of beta testing and product development.
            </p>
          </motion.div>
        </div>
      </section>
