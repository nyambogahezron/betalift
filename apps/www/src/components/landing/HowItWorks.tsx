...
const steps = [
	{
		...
		description:
			"Set up your workspace, define project goals, and organize your initial tasks.",
	...
	},
	{
		...
		description:
			"Connect with collaborators, assign roles, and build your dream team.",
	...
	},
	{
		...
		title: "Collaborate",
		description:
			"Chat in real-time, share files, manage tasks, and gather feedback seamlessly.",
			...
			<div className="container relative z-10 mx-auto px-4">
				...
				>
					...
					<h2 className="font-display text-3xl md:text-5xl font-bold text-foreground mb-4">
						Three Steps to <span className="highlight-box">Success</span>
					</h2>
					<p className="text-lg text-muted-foreground">
						From idea to launch. Our streamlined process makes collaboration
						effortless.
					</p>
				</motion.div>
						...
						{steps.map((step, index) => (
							...
							>
								...
								<div className="glass-card rounded-3xl p-8 text-center hover:shadow-card-hover transition-all duration-300 hover:-translate-y-2">
									...
									{/* Icon */}
									<div
										className={`w-16 h-16 mx-auto rounded-2xl bg-gradient-to-r ${step.color} flex items-center justify-center mb-6 shadow-lg`}
									>
				...
				>
					<p className="text-muted-foreground mb-4">Ready to start building?</p>
					<motion.button
