...
const floatingCards = [
  ...
  },
  {
    ...
    author: "DevOps Lead",
    timeAgo: "1h ago",
    description: "Actually, latency spike was due to a scheduled load test and has normalized.",
    sources: ["Datadog", "AWS"],
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold text-foreground leading-tight mb-6">
            Streamline Your{" "}
            <span className="highlight-box">Project</span>{" "}
            Collaboration.
            <br />
            Connect & Manage{" "}
          ...
          >
            Connect users, manage projects, and facilitate real-time feedback and communication with Betalift.
          </motion.p>
        </motion.div>
        ...
        >
          <button
            className="rounded-full px-8 py-4 text-base font-semibold bg-primary text-primary-foreground shadow-button hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5"
          >
            Get Started
          </button>
        </motion.div>
